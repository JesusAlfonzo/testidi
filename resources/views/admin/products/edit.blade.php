            ...
            <div class="card" style="border-left: 4px solid #f59e0b;">
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="number" name="expiry_warning_days" class="form-control" value="{{ old('expiry_warning_days', $product->expiry_warning_days ?? $defaultExpiryDays) }}" min="1" max="365">
                                            </div>
                                            <small class="form-text text-muted">Días antes del vencimiento para mostrar alerta.</small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-warning text-dark"><i class="fas fa-sync-alt"></i> Actualizar Producto</button>
