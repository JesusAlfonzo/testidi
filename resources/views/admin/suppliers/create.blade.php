                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Ej: Insumos Médicos C.A." required>
                                            </div>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="tax_id" id="tax_id" class="form-control @error('tax_id') is-invalid @enderror" value="{{ old('tax_id') }}" placeholder="J-00000000-0">
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="contact_person" id="contact_person" class="form-control @error('contact_person') is-invalid @enderror" value="{{ old('contact_person') }}" placeholder="Nombre del contacto directo">
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="representative_cedula" id="representative_cedula" class="form-control @error('representative_cedula') is-invalid @enderror" value="{{ old('representative_cedula') }}" placeholder="V-00000000">
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="proveedor@ejemplo.com">
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="+58 412-0000000">
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="3" placeholder="Dirección física principal del proveedor.">{{ old('address') }}</textarea>
                                            </div>
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea name="fiscal_address" id="fiscal_address" class="form-control @error('fiscal_address') is-invalid @enderror" rows="3" placeholder="Dirección fiscal para emisión de facturas.">{{ old('fiscal_address') }}</textarea>
                                            </div>
