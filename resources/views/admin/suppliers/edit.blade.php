...
@section('title', 'Maestros | Editar Proveedor')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="text-dark font-weight-bold" style="font-size: 1.75rem;">
                <i class="fas fa-truck text-primary mr-2"></i> Editar Proveedor
            </h1>
            <p class="text-muted mb-0">Modifique la información del proveedor registrado.</p>
        </div>
                ...
                <form action="{{ route('admin.suppliers.update', $supplier) }}" method="POST">
                        ...
                        <div class="col-md-7 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                       value="{{ old('name', $supplier->name) }}" placeholder="Ej: Insumos Médicos C.A." 
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="tax_id" id="tax_id" class="form-control @error('tax_id') is-invalid @enderror" 
                                       value="{{ old('tax_id', $supplier->tax_id) }}" placeholder="J-00000000-0" 
                                       style="border-top-right-radius: 8px; border-bottom-right-radius: 8px;" required>
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="contact_person" id="contact_person" class="form-control @error('contact_person') is-invalid @enderror" 
                                       value="{{ old('contact_person', $supplier->contact_person) }}" placeholder="Nombre del contacto directo" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="representative_cedula" id="representative_cedula" class="form-control @error('representative_cedula') is-invalid @enderror" 
                                       value="{{ old('representative_cedula', $supplier->representative_cedula) }}" placeholder="V-00000000" 
                                       style="border-top-right-radius: 8px; border-bottom-right-radius: 8px;">
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" 
                                       value="{{ old('email', $supplier->email) }}" placeholder="proveedor@ejemplo.com" 
                                       style="border-top-right-radius: 8px; border-bottom-right-radius: 8px;">
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" 
                                       value="{{ old('phone', $supplier->phone) }}" placeholder="+58 412-0000000" 
                                       style="border-top-right-radius: 8px; border-bottom-right-radius: 8px;">
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" 
                                      ...
                                      style="border-radius: 8px;">{{ old('address', $supplier->address) }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="fiscal_address" id="fiscal_address" class="form-control @error('fiscal_address') is-invalid @enderror" 
                                      ...
                                      style="border-radius: 8px;">{{ old('fiscal_address', $supplier->fiscal_address) }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="is_active" id="is_active" class="form-control" style="border-radius: 8px;">
                                <option value="1" {{ old('is_active', $supplier->is_active ?? '1') == '1' || old('is_active', $supplier->is_active ?? '1') === true ? 'selected' : '' }}>Activo</option>
                                <option value="0" {{ old('is_active', $supplier->is_active ?? '1') == '0' || old('is_active', $supplier->is_active ?? '1') === false ? 'selected' : '' }}>Inactivo</option>
                            </select>
                    ...
                    <div class="row mt-4 mb-2 bg-light p-3 rounded" style="font-size: 0.8rem; border: 1px solid #e5e7eb; border-radius: 8px;">
                        <div class="col-4">
                            ...
                            <span class="text-dark font-weight-bold">{{ $supplier->user->name ?? 'N/A' }}</span>
                        </div>
                        <div class="col-4">
