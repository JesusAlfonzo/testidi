...
@section('content_header')
    <h1><i class="fas fa-shopping-cart"></i> Editar Orden de Compra</h1>
@stop
                            ...
                            <table class="table table-bordered table-striped mb-0" id="itemsTable">
                                    ...
                                    @foreach($purchaseOrder->items as $index => $item)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-danger remove-item" {{ $purchaseOrder->items->count() <= 1 ? 'style=display:none' : '' }}>
                                ...
                                <tfoot class="bg-success-light">
                                    <tr>
                                        ...
                                        <th class="text-right"><span id="grandTotal" class="h5 text-success">${{ number_format($purchaseOrder->total, 2) }}</span></th>
                                        <th></th>
                                    </tr>
            ...
            <div class="col-12">
                <div class="card" style="border-left: 4px solid #9ca3af;">
                    <div class="card-header" style="background: linear-gradient(135deg, #9ca3af 0%, #d1d5db 100%);">
                        <h3 class="card-title text-white">
                            <i class="fas fa-sticky-note"></i> Notas y Términos
                        </h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group mb-2">
                                    <label for="terms" class="mb-1">Términos y Condiciones</label>
                                    <textarea name="terms" id="terms" rows="2" class="form-control form-control-sm" placeholder="Condiciones de pago, garantías, etc.">{{ old('terms', $purchaseOrder->terms) }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-0">
                                    <label for="notes" class="mb-1">Notas Internas</label>
                                    <textarea name="notes" id="notes" rows="2" class="form-control form-control-sm" placeholder="Notas adicionales">{{ old('notes', $purchaseOrder->notes) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
