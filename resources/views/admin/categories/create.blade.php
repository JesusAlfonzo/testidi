                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="p-3 border rounded bg-light text-center">
                                                <span id="previewBadge" class="badge badge-info" style="font-size: 1rem; padding: 0.5rem 1rem;">
                                                    <i class="fas fa-tag"></i> <span id="previewText">Nombre</span>
                                                </span>
                                                <small class="d-block text-muted mt-2">Así se verá la categoría</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group mb-0">
                                            ...
                                            <textarea name="description" id="description" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Describa brevemente qué tipo de productos agrupa esta categoría y su propósito dentro del inventario.">{{ old('description') }}</textarea>
