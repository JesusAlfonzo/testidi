    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="text-dark font-weight-bold" style="font-size: 1.75rem;">
                <i class="fas fa-layer-group text-primary mr-2"></i> Crear Categoría
            </h1>
            <p class="text-muted mb-0">Registre una nueva categoría para clasificar productos en el inventario.</p>
        </div>
            ...
            <div class="card p-4 bg-white" style="border-radius: 12px; border: 1px solid #e5e7eb; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);">
                <form action="{{ route('admin.categories.store') }}" method="POST">
                    ...
                    <h5 class="font-weight-bold text-dark mb-4">
                        <i class="fas fa-info-circle text-info mr-2"></i> Detalle de la Categoría
                    </h5>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" 
                                   value="{{ old('name') }}" placeholder="Ej: Reactivos de Inmunología, Insumos Generales" 
